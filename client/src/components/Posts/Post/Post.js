...
import ThumbDownAltOutlined from '@material-ui/icons/ThumbDownAlt';
    ...
    return(
        < Card className={classes.card} raised elevation={6}>
            ...
            <CardActions className={classes.cardActions}>
                ...
                {(user?.result?.googleId === post?.creator || user?.result?._id === post?.creator) && (<Button size="small" color="secondary" onClick={() => dispatch(deletePost(post._id))}>
